...
class LoadSearchService:
    ...
    def _normalize_state(self, state: str) -> str:
        ...
        # Look up in mapping
        return self.STATE_MAPPING.get(state_lower, state.upper())
    ...
    def search_loads(self, search_request: LoadSearchRequest) -> dict:
        ...
        normalized_origin_state = self._normalize_state(search_request.origin_state)
        normalized_destination_state = self._normalize_state(search_request.destination_state)
        ...
        for load in all_loads:
            location_score = self._calculate_location_score(
                load, search_request, normalized_origin_state, normalized_destination_state
            )
    ...
    def _calculate_location_score(self, load: Load, search_request: LoadSearchRequest, 
                                normalized_origin_state: str, normalized_destination_state: str) -> float:
        """
        ...
        Args:
            ...
            normalized_origin_state: Normalized origin state abbreviation
            normalized_destination_state: Normalized destination state abbreviation
        ...
        origin_score = self._calculate_single_location_score(
            ...
            search_request.origin_city, normalized_origin_state
        )
        
        # Destination scoring
        dest_score = self._calculate_single_location_score(
            load.destination_city, load.destination_state,
            search_request.destination_city, normalized_destination_state
        )
    ...
    def _calculate_single_location_score(self, load_city: str, load_state: str, 
        ...
        if requested_city and requested_state:
            ...
            if city_match and state_match:
                ...
                return 75   # State match, wrong city - HIGHER priority for same state
            else:
                return 0    # No match
        elif requested_city:
            # Only city specified
